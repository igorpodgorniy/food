...
function modal(modalSelector, modalTimerId) {
    ...
    document.addEventListener('click', e => {
        ...
        } else if (e.target.dataset.close === '' || e.target.className === 'modal show') {
...
function timer(id, deadline) {
    function getTimeRemaining(endtime) {
        ...
        const hours = Math.floor(t / (1000 * 60 * 60 *24) % 24);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021-04-11');
